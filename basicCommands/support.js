...
module.exports = {
    ...
    execute(message, args) {
        const supportServerLink = "https://discord.gg/wdCZgK3Pmp";
      const bmcguildLink = "https://blocksmc.com/guild/legends";
      const replitLink = "https://replit.com/@";
      const youtubeLink = "https://www.youtube.com/@Legends_313_Clan";
        const embed = new EmbedBuilder()
            ...
            .setDescription(`➡️ **Join our Discord server for support and updates:**\n- Discord - ${supportServerLink}\n\n➡️ **Follow us on:**\n- BlocksMC - Legends (LGN) Guild - ${bmcguildLink}\n- YouTube - ${youtubeLink}`)
